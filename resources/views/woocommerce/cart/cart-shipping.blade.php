...
if($session_date_object) {
	...
	if ($pickup_day_of_week === "Saturday" && $pickup_date != "2026-03-07" && !$icecream_conflict && !$delivery_override) {
		$delivery_available = true;
	}
	...
	if ($pickup_date == "2026-03-07" ) {
		$delivery_message = "Sorry! we're at capacity for delivery on Saturday, March 7, but we'd love to see your face in the store!";
	}
	else {

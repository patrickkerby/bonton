  ...
  @while(have_posts()) @php the_post() @endphp
      ...
      <div class="container-fluid videos process">
        <div class="row no-gutters justify-content-center">
          <img class="illustration" width="774px" height="335px" src="{{ $intro->intro_image }}" />
        </div>
        <div class="row no-gutters justify-content-center">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-6 col-lg-4 cta">
            ...
            <div class="feeds">
              ...
              <a href="https://us20.campaign-archive.com/home/?u=f07999ddf32b42be0af661143&id=9fe85973c9" target="_blank" class="icon newsletter" data-toggle="tooltip" data-placement="top" title="See all past newsletters"><img src="@asset('images/newsletter.svg')" /></a>
            </div>
          </div>
        </div>
      </section>
